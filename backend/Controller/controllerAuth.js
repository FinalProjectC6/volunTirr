const{Seekers}=require('../database/index.js')
const jwt = require('jsonwebtoken');
const bcrypt = require('bcrypt');
const {createseeker}=require('./controllerseeker.js')


console.log(Seekers,'usersssssssssssssssss');
...
const generateToken = (id, fullname) => {
 ...
 const Register = async (req, res) => {
  ...
  const Login = async(req, res) => {
    ...
    try {
        const result= await Seekers.findOne({ where :{email_address:email_address}})
